...
INSERT INTO GroupFilter VALUES(1,'Continue Watching (SYSTEM)',0,1,'4;2',1,2,3,'{}',1,'[{"GroupFilterConditionID":0,"GroupFilterID":1,"ConditionType":28,"ConditionOperator":1,"ConditionParameter":""},{"GroupFilterConditionID":0,"GroupFilterID":1,"ConditionType":3,"ConditionOperator":1,"ConditionParameter":""}]',NULL,0,2,'{}');
INSERT INTO GroupFilter VALUES(2,'All',0,1,'5;1',1,4,3,'{}',1,'[]',NULL,0,2,'{}');
INSERT INTO GroupFilter VALUES(3,'Tags',0,1,'13;1',1,24,3,'{}',1,'[]',NULL,0,2,'{}');
INSERT INTO GroupFilter VALUES(4,'Years',0,1,'13;1',1,40,3,'{}',1,'[]',NULL,0,2,'{}');
INSERT INTO GroupFilter VALUES(5,'Seasons',0,1,'13;1',1,72,3,'{}',1,'[]',NULL,0,2,'{}');
...
INSERT INTO JMMUser VALUES(1,'Default','',1,1,1,'',1,NULL,NULL);
INSERT INTO JMMUser VALUES(2,'Family Friendly','',1,1,1,'ecchi,nudity,sex,sexual abuse,horror,erotic game,incest,18 restricted',1,NULL,NULL);
...
INSERT INTO CustomTag VALUES(1,'Dropped','Started watching this series, but have since dropped it');
INSERT INTO CustomTag VALUES(2,'Pinned','Pinned this series for whatever reason you like');
INSERT INTO CustomTag VALUES(3,'Ongoing','This series does not have an end date');
INSERT INTO CustomTag VALUES(4,'Waiting for Series Completion','Will start watching this once this series is finished');
INSERT INTO CustomTag VALUES(5,'Waiting for Blu-ray Completion','Will start watching this once all episodes are available in Blu-Ray');
...
CREATE INDEX IX_AniDB_Anime_Category_AnimeID on AniDB_Anime_Category(AnimeID);
...
CREATE UNIQUE INDEX UIX_AniDB_Seiyuu_SeiyuuID ON AniDB_Seiyuu(SeiyuuID);
CREATE UNIQUE INDEX UIX_AniDB_File_Hash on AniDB_File(Hash);
...
CREATE UNIQUE INDEX UIX_AniDB_Review_ReviewID ON AniDB_Review(ReviewID);
CREATE UNIQUE INDEX UIX_AniDB_Tag_TagID ON AniDB_Tag(TagID);
...
CREATE UNIQUE INDEX UIX_AnimeSeries_AniDB_ID ON AnimeSeries(AniDB_ID);
...
CREATE UNIQUE INDEX UIX_Language_LanguageName ON Language(LanguageName);
CREATE UNIQUE INDEX UIX_ScheduledUpdate_UpdateType ON ScheduledUpdate(UpdateType);
CREATE UNIQUE INDEX UIX_TvDB_ImageFanart_Id ON TvDB_ImageFanart(Id);
CREATE UNIQUE INDEX UIX_TvDB_ImageWideBanner_Id ON TvDB_ImageWideBanner(Id);
CREATE UNIQUE INDEX UIX_TvDB_ImagePoster_Id ON TvDB_ImagePoster(Id);
CREATE UNIQUE INDEX UIX_TvDB_Series_Id ON TvDB_Series(SeriesID);
CREATE UNIQUE INDEX UIX_AniDB_Anime_DefaultImage_ImageType ON AniDB_Anime_DefaultImage(AnimeID, ImageType);
CREATE UNIQUE INDEX UIX_MovieDB_Movie_Id ON MovieDB_Movie(MovieId);
...
CREATE UNIQUE INDEX UIX_Trakt_Friend_Username ON Trakt_Friend(Username);
...
CREATE INDEX IX_CrossRef_File_Episode_Hash ON CrossRef_File_Episode(Hash);
...
CREATE UNIQUE INDEX [UIX_CloudAccount_CloudID] ON [CloudAccount] ([CloudID]);
CREATE UNIQUE INDEX UIX2_VideoLocal_User_User_VideoLocalID ON VideoLocal_User(JMMUserID, VideoLocalID);
CREATE INDEX IX_VideoLocal_Hash ON VideoLocal(Hash);
CREATE INDEX UIX_ScanFileStatus ON ScanFile(ScanID,Status,CheckDate);
...
CREATE UNIQUE INDEX UIX_AniDB_AnimeUpdate ON AniDB_AnimeUpdate(AnimeID);
