...
public class SortingSelectorTests
{
    ...
    public static TheoryData<string, string, string, string> SelectorProperties() => new()
    {
        ...
        { "LocalSuggestionCountSortingSelector", "filterable", "LocalSuggestions", "" },
        ...
        { "TmdbSuggestionCountSortingSelector", "filterable", "TmdbSuggestions", "" },
        { "TotalEpisodeCountSortingSelector", "filterable", "TotalEpisodeCount", "" },
        { "TotalSuggestionCountSortingSelector", "filterable", "TotalSuggestions", "" },
