...
public class AnimeSeriesStatsTests
{
    ...
    private sealed record EpisodeSpec(int Number, bool HasFile, bool Aired = true, bool Hidden = false, EpisodeType Type = EpisodeType.Episode);
    ...
    private sealed class Harness : IDisposable
    {
        ...
        public Harness(IEnumerable<EpisodeSpec> specs)
        {
            ...
            foreach (var spec in specs)
            {
                ...
                anidbEpisodes.Add(new AniDB_Episode
                {
                    ...
                    AirDate = spec.Aired ? (int)(s_aired - new DateTime(1970, 1, 1)).TotalSeconds : 0,
                });
            ...
            _scope = new RepoFactoryScope()
                ...
                .With<AniDB_AnimeRepository, int, AniDB_Anime>(a => a.AniDB_AnimeID,
                    [new AniDB_Anime { AniDB_AnimeID = 1, AnimeID = AnimeID, MainTitle = "Test", AnimeType = AnimeType.TV, AirDate = new PartialDateOnly(2020, 1, 1) }])
            ...
            Service = new AnimeSeriesService(
                ...
                anidbGroupStatuses: GroupStatuses(),
        ...
        /// </summary>
        private static AniDB_GroupStatusRepository GroupStatuses()
        {
            var mock = new Mock<AniDB_GroupStatusRepository>((DatabaseFactory)null!, (IQueueScheduler)null!);
            mock.Setup(r => r.GetByAnimeID(It.IsAny<int>())).Returns([]);
            return mock.Object;
        }
    ...
    [Fact]
    public void AnUnairedEpisodeIsNotCountedAsMissing()
    {
        using var harness = Create(new EpisodeSpec(1, HasFile: false, Aired: false));
