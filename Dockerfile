...
RUN dotnet build -c=Release -o=/usr/src/app/build/ Shoko.CLI/Shoko.CLI.csproj "/p:Version=${version},InformationalVersion=\"channel=${release}; commit=${commit}; tag=${tag}\""
