...
/// <summary>
///   Reconcile the AniDB MyList entries covering every file for the episode against the
...
public sealed class SyncEpisodeMyListAction(IMyListService myListService) : EpisodeAction
{
    ...
    public override string? Description => "Reconciles your AniDB MyList with the local state for every file for the episode.";
    ...
    public override Task Execute(CancellationToken token = default)
        => myListService.ScheduleSync(MyListActionScope.VideosOf(Episode));
}
