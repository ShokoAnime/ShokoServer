...
public class LegacyMappings
{
    ...
    public static FilterExpression<bool> GetTagExpression(CL_GroupFilterOperator op, string parameter, bool suppressErrors = false)
    {
        ...
        switch (op)
        {
            ...
            case CL_GroupFilterOperator.In:
            {
            ...
            case CL_GroupFilterOperator.NotIn:
            {
    ...
    public static FilterExpression<bool> GetAirDateExpression(CL_GroupFilterOperator op, string parameter, bool suppressErrors = false)
    {
        return GetDateExpression(new AirDateSelector(), op, parameter, suppressErrors);
    }

    public static FilterExpression<bool> GetLastAirDateExpression(CL_GroupFilterOperator op, string parameter, bool suppressErrors = false)
    {
        return GetDateExpression(new LastAirDateSelector(), op, parameter, suppressErrors);
    }

    public static FilterExpression<bool> GetAddedDateExpression(CL_GroupFilterOperator op, string parameter, bool suppressErrors = false)
    {
        return GetDateExpression(new AddedDateSelector(), op, parameter, suppressErrors);
    }

    public static FilterExpression<bool> GetLastAddedDateExpression(CL_GroupFilterOperator op, string parameter, bool suppressErrors = false)
    {
        return GetDateExpression(new LastAddedDateSelector(), op, parameter, suppressErrors);
    }

    public static FilterExpression<bool> GetWatchedDateExpression(CL_GroupFilterOperator op, string parameter, bool suppressErrors = false)
    {
    ...
    public static FilterExpression<bool> GetVideoQualityExpression(CL_GroupFilterOperator op, string parameter, bool suppressErrors = false)
    {
        ...
        switch (op)
        {
            ...
            case CL_GroupFilterOperator.InAllEpisodes:
            {
            ...
            case CL_GroupFilterOperator.NotInAllEpisodes:
            {
    ...
    public static FilterExpression<bool> GetGroupExpression(CL_GroupFilterOperator op, string parameter, bool suppressErrors = false)
    {
        ...
        switch (op)
        {
            ...
            case CL_GroupFilterOperator.Equals:
            {
            ...
            case CL_GroupFilterOperator.NotEquals:
            {
                if (groups.Length > 1) throw new ArgumentOutOfRangeException(nameof(op), $@"ConditionOperator {op} not applicable for Group Name and more than one value");
