...
public class MySQL(SystemService systemService) : BaseDatabase<MySqlConnection>(systemService)
{
    ...
    [
        ...
        new(187,  1, "CREATE TABLE `Anilist_Anime` ( `Anilist_AnimeID` INT NOT NULL AUTO_INCREMENT, `AnilistAnimeID` INT NOT NULL, `MalID` INT NULL, `EnglishTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `MainTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `NativeTitle` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `Synonyms` TEXT CHARACTER SET UTF8 NOT NULL, `EnglishOverview` TEXT CHARACTER SET UTF8 NOT NULL, `OriginalLanguageCode` VARCHAR(32) CHARACTER SET UTF8 NOT NULL, `Type` INT NOT NULL, `ReleasingStatus` INT NOT NULL, `MediaSource` INT NOT NULL, `Season` INT NULL, `SeasonYear` INT NULL, `CoverImagePath` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `BannerImagePath` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `TrailerSite` VARCHAR(32) NULL, `TrailerID` VARCHAR(64) CHARACTER SET UTF8 NULL, `EpisodeCount` INT NOT NULL, `EpisodeDuration` INT NULL, `UserRating` decimal(6,2) NOT NULL, `MeanScore` decimal(6,2) NOT NULL, `UserVotes` INT NOT NULL, `Popularity` INT NOT NULL, `FavoriteCount` INT NOT NULL, `IsLicensed` BIT NOT NULL, `IsRestricted` BIT NOT NULL, `Color` VARCHAR(32) CHARACTER SET UTF8 NOT NULL, `Genres` TEXT CHARACTER SET UTF8 NOT NULL, `FirstAiredAt` VARCHAR(10) NULL, `LastAiredAt` VARCHAR(10) NULL, `CreatedAt` DATETIME NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`Anilist_AnimeID`) );"),
        ...
        new(187,  3, "CREATE TABLE `Anilist_Tag` ( `Anilist_TagID` INT NOT NULL AUTO_INCREMENT, `AnilistTagID` INT NOT NULL, `Name` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `Description` TEXT CHARACTER SET UTF8 NOT NULL, `Category` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `IsRestricted` BIT NOT NULL, `IsSpoiler` BIT NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`Anilist_TagID`) );"),
        ...
        new(187,  5, "CREATE TABLE `Anilist_Studio` ( `Anilist_StudioID` INT NOT NULL AUTO_INCREMENT, `AnilistStudioID` INT NOT NULL, `Name` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `IsAnimationStudio` BIT NOT NULL, `FavoriteCount` INT NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`Anilist_StudioID`) );"),
        ...
        new(187,  7, "CREATE TABLE `Anilist_Character` ( `Anilist_CharacterID` INT NOT NULL AUTO_INCREMENT, `AnilistCharacterID` INT NOT NULL, `Name` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `OriginalName` VARCHAR(512) CHARACTER SET UTF8 NULL, `AlternativeNames` TEXT CHARACTER SET UTF8 NOT NULL, `Description` TEXT CHARACTER SET UTF8 NOT NULL, `ImagePath` VARCHAR(512) CHARACTER SET UTF8 NULL, `Gender` INT NOT NULL, `DateOfBirth` VARCHAR(10) NULL, `Age` VARCHAR(512) CHARACTER SET UTF8 NULL, `FavoriteCount` INT NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`Anilist_CharacterID`) );"),
        new(187,  8, "CREATE TABLE `Anilist_Creator` ( `Anilist_CreatorID` INT NOT NULL AUTO_INCREMENT, `AnilistCreatorID` INT NOT NULL, `Name` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `OriginalName` VARCHAR(512) CHARACTER SET UTF8 NULL, `AlternativeNames` TEXT CHARACTER SET UTF8 NOT NULL, `Description` TEXT CHARACTER SET UTF8 NOT NULL, `ImagePath` VARCHAR(512) CHARACTER SET UTF8 NULL, `Language` VARCHAR(512) CHARACTER SET UTF8 NULL, `PrimaryOccupations` TEXT CHARACTER SET UTF8 NOT NULL, `Gender` INT NOT NULL, `DateOfBirth` VARCHAR(10) NULL, `HomeTown` VARCHAR(512) CHARACTER SET UTF8 NULL, `FavoriteCount` INT NOT NULL, `LastUpdatedAt` DATETIME NOT NULL, PRIMARY KEY (`Anilist_CreatorID`) );"),
        new(187,  9, "CREATE TABLE `Anilist_Anime_Character` ( `Anilist_Anime_CharacterID` INT NOT NULL AUTO_INCREMENT, `AnilistAnimeID` INT NOT NULL, `AnilistCharacterID` INT NOT NULL, `Role` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `Ordering` INT NOT NULL, PRIMARY KEY (`Anilist_Anime_CharacterID`) );"),
        new(187, 10, "CREATE TABLE `Anilist_Anime_Character_Creator` ( `Anilist_Anime_Character_CreatorID` INT NOT NULL AUTO_INCREMENT, `AnilistAnimeID` INT NOT NULL, `AnilistCharacterID` INT NOT NULL, `AnilistCreatorID` INT NOT NULL, `RoleNotes` VARCHAR(512) CHARACTER SET UTF8 NULL, `DubGroup` VARCHAR(512) CHARACTER SET UTF8 NULL, `Ordering` INT NOT NULL, PRIMARY KEY (`Anilist_Anime_Character_CreatorID`) );"),
        new(187, 11, "CREATE TABLE `Anilist_Anime_Staff` ( `Anilist_Anime_StaffID` INT NOT NULL AUTO_INCREMENT, `AnilistAnimeID` INT NOT NULL, `AnilistCreatorID` INT NOT NULL, `Role` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `Ordering` INT NOT NULL, PRIMARY KEY (`Anilist_Anime_StaffID`) );"),
        new(187, 12, "CREATE TABLE `Anilist_Anime_Relation` ( `Anilist_Anime_RelationID` INT NOT NULL AUTO_INCREMENT, `AnilistAnimeID` INT NOT NULL, `RelatedAnilistID` INT NOT NULL, `RelatedIsAnime` BIT NOT NULL, `RelationType` VARCHAR(32) CHARACTER SET UTF8 NOT NULL, PRIMARY KEY (`Anilist_Anime_RelationID`) );"),
        ...
        new(187, 40, "CREATE TABLE `Anilist_Anime_ExternalLink` ( `Anilist_Anime_ExternalLinkID` INT NOT NULL AUTO_INCREMENT, `AnilistAnimeID` INT NOT NULL, `AnilistLinkID` INT NOT NULL, `Url` VARCHAR(512) CHARACTER SET UTF8 NOT NULL, `Site` VARCHAR(128) CHARACTER SET UTF8 NOT NULL, `AnilistSiteID` INT NULL, `LinkType` VARCHAR(32) NOT NULL, `LanguageCode` VARCHAR(32) NULL, PRIMARY KEY (`Anilist_Anime_ExternalLinkID`) );"),
