...
public class MySQL : BaseDatabase<MySqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new(158, 03, "CREATE TABLE `VideoLocal_HashDigest` (`VideoLocal_HashDigestID` INT NOT NULL AUTO_INCREMENT, `VideoLocalID` INT NOT NULL, `Type` VARCHAR(32) NOT NULL, `Value` TEXT NOT NULL, `Metadata` TEXT, PRIMARY KEY (`VideoLocal_HashDigestID`));"),
