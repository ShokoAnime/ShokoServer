...
public class MySQL : BaseDatabase<MySqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new(154, 01, "CREATE TABLE `StoredReleaseInfo` (`StoredReleaseInfoID` INT NOT NULL AUTO_INCREMENT, `ED2K` VARCHAR(40) NOT NULL, `FileSize` BIGINT NOT NULL, `ID` VARCHAR(128), `ProviderName` VARCHAR(128) NOT NULL, `ReleaseURI` VARCHAR(1024), `Revision` INT NOT NULL, `ProvidedFileSize` BIGINT, `Comment` VARCHAR(1024), `OriginalFilename` VARCHAR(1024), `IsCensored` INT, `IsChaptered` INT, `IsCreditless` INT, `IsCorrupted` INT NOT NULL, `Source` INT NOT NULL, `GroupID` VARCHAR(128), `GroupSource` VARCHAR(128), `GroupName` VARCHAR(128), `GroupShortName` VARCHAR(128), `Hashes` BLOB NULL, `AudioLanguages` VARCHAR(128), `SubtitleLanguages` VARCHAR(128), `CrossReferences` VARCHAR(10240) NOT NULL, `ReleasedAt` DATE, `LastUpdatedAt` DATETIME NOT NULL, `CreatedAt` DATETIME NOT NULL, PRIMARY KEY (`StoredReleaseInfoID`));"),
