...
public class MySQL : BaseDatabase<MySqlConnection>, IDatabase
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new DatabaseCommand(103, 1, "ALTER TABLE AniDB_GroupStatus MODIFY GroupName LONGTEXT NULL; ALTER TABLE AniDB_GroupStatus MODIFY EpisodeRange LONGTEXT NULL;"),
    };
