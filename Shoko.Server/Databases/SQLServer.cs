...
public class SQLServer : BaseDatabase<SqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new DatabaseCommand(150, 03, "CREATE TABLE VideoLocal_HashDigest (VideoLocal_HashDigestID INT IDENTITY(1,1), VideoLocalID INT NOT NULL, Type NVARCHAR(32) NOT NULL, Value TEXT NOT NULL, Metadata TEXT);"),
        ...
        new DatabaseCommand(151, 13, "ALTER TABLE AnimeSeries_User ADD LastVideoUpdate datetime2;"),
        new DatabaseCommand(151, 14, "ALTER TABLE AnimeSeries_User ADD LastUpdated datetime2 NOT NULL DEFAULT '0001-01-01 00:00:00';"),
        new DatabaseCommand(151, 15, "ALTER TABLE AnimeSeries_User ADD UserTags TEXT NOT NULL DEFAULT '';"),
        new DatabaseCommand(151, 16, "ALTER TABLE AnimeEpisode_User ADD AbsoluteUserRating INT;"),
        new DatabaseCommand(151, 17, "ALTER TABLE AnimeEpisode_User ADD IsFavorite INT NOT NULL DEFAULT 0;"),
        new DatabaseCommand(151, 18, "ALTER TABLE AnimeEpisode_User ADD LastUpdated datetime2 NOT NULL DEFAULT '0001-01-01 00:00:00';"),
        new DatabaseCommand(151, 19, "ALTER TABLE AnimeEpisode_User ADD UserTags TEXT NOT NULL DEFAULT '';"),
        new DatabaseCommand(151, 20, DatabaseFixes.MigrateAnidbVotes),
