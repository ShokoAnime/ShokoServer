...
public class SQLServer : BaseDatabase<SqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new DatabaseCommand(122, 10, "CREATE TABLE TMDB_Person ( TMDB_PersonID INT IDENTITY(1,1) NOT NULL, TmdbPersonID INT NOT NULL, EnglishName NVARCHAR(512) NOT NULL, EnglishBiography NVARCHAR(MAX) NOT NULL, Aliases NVARCHAR(MAX) NOT NULL, Gender INT NOT NULL, IsRestricted BIT NOT NULL, BirthDay DATE NULL, DeathDay DATE NULL, PlaceOfBirth VARCHAR(NVARCHAR(MAX) NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
