...
public class SQLServer : BaseDatabase<SqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new DatabaseCommand(138, 1, "ALTER TABLE TMDB_Person ALTER COLUMN CreatedAt datetime2; ALTER TABLE TMDB_Person ALTER COLUMN LastUpdatedAt datetime2"),
        new DatabaseCommand(138, 2, "ALTER TABLE TMDB_Movie ALTER COLUMN CreatedAt datetime2; ALTER TABLE TMDB_Movie ALTER COLUMN LastUpdatedAt datetime2"),
        new DatabaseCommand(138, 3, "ALTER TABLE TMDB_Show ALTER COLUMN CreatedAt datetime2; ALTER TABLE TMDB_Show ALTER COLUMN LastUpdatedAt datetime2"),
        new DatabaseCommand(138, 4, "ALTER TABLE TMDB_Season ALTER COLUMN CreatedAt datetime2; ALTER TABLE TMDB_Season ALTER COLUMN LastUpdatedAt datetime2"),
        new DatabaseCommand(138, 5, "ALTER TABLE TMDB_Episode ALTER COLUMN CreatedAt datetime2; ALTER TABLE TMDB_Episode ALTER COLUMN LastUpdatedAt datetime2"),
        new DatabaseCommand(138, 6, "ALTER TABLE TMDB_AlternateOrdering ALTER COLUMN CreatedAt datetime2; ALTER TABLE TMDB_AlternateOrdering ALTER COLUMN LastUpdatedAt datetime2"),
        new DatabaseCommand(138, 7, "ALTER TABLE TMDB_AlternateOrdering_Season ALTER COLUMN CreatedAt datetime2; ALTER TABLE TMDB_AlternateOrdering_Season ALTER COLUMN LastUpdatedAt datetime2"),
        new DatabaseCommand(138, 8, "ALTER TABLE TMDB_AlternateOrdering_Episode ALTER COLUMN CreatedAt datetime2; ALTER TABLE TMDB_AlternateOrdering_Episode ALTER COLUMN LastUpdatedAt datetime2"),
        new DatabaseCommand(138, 9, "ALTER TABLE TMDB_Collection ALTER COLUMN CreatedAt datetime2; ALTER TABLE TMDB_Collection ALTER COLUMN LastUpdatedAt datetime2"),
    };
