...
public class SQLServer : BaseDatabase<SqlConnection>
{
    ...
    private List<DatabaseCommand> patchCommands = new()
    {
        ...
        new DatabaseCommand(112, 1, "CREATE TABLE CrossRef_AniDB_TMDB_Episode ( CrossRef_AniDB_TMDB_EpisodeID INT IDENTITY(1,1) NOT NULL, AnidbAnimeID INT NOT NULL, AnidbEpisodeID INT NOT NULL, TmdbShowID INT NOT NULL, TmdbEpisodeID INT NOT NULL, Ordering INT NOT NULL, MatchRating INT NOT NULL );"),
        ...
        new DatabaseCommand(112, 3, "CREATE TABLE CrossRef_AniDB_TMDB_Show ( CrossRef_AniDB_TMDB_ShowID INT IDENTITY(1,1) NOT NULL, AnidbAnimeID INT NOT NULL, TmdbShowID INT NOT NULL, Source INT NOT NULL );"),
        ...
        new DatabaseCommand(112, 10, "CREATE TABLE TMDB_Person ( TMDB_PersonID INT IDENTITY(1,1) NOT NULL, TmdbPersonID INT NOT NULL, EnglishName NVARCHAR(512) NOT NULL, EnglishBiography NVARCHAR(MAX) NOT NULL, Aliases NVARCHAR(MAX) NOT NULL, Gender INT NOT NULL, IsRestricted BIT NOT NULL, BirthDay DATE NULL, DeathDay DATE NULL, PlaceOfBirth VARCHAR(NVARCHAR(MAX) NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
        ...
        new DatabaseCommand(112, 12, "CREATE TABLE TMDB_Movie_Cast ( TMDB_Movie_CastID INT IDENTITY(1,1) NOT NULL, TmdbMovieID INT NOT NULL, TmdbPersonID INT NOT NULL, TmdbCreditID NVARCHAR(64) NOT NULL, CharacterName NVARCHAR(512) NOT NULL, Ordering INT NOT NULL );"),
        new DatabaseCommand(112, 13, "CREATE TABLE TMDB_Company_Entity ( TMDB_Company_EntityID INT IDENTITY(1,1) NOT NULL, TmdbCompanyID INT NOT NULL, TmdbEntityType INT NOT NULL, TmdbEntityID INT NOT NULL, Ordering INT NOT NULL, ReleasedAt DATE NULL );"),
        ...
        new DatabaseCommand(112, 21, "CREATE TABLE TMDB_AlternateOrdering ( TMDB_AlternateOrderingID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbNetworkID INT NULL, TmdbEpisodeGroupCollectionID NVARCHAR(64) NOT NULL, EnglishTitle NVARCHAR(512) NOT NULL, EnglishOverview NVARCHAR(MAX) NOT NULL, EpisodeCount INT NOT NULL, SeasonCount INT NOT NULL, Type INT NOT NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
        ...
        new DatabaseCommand(112, 23, "CREATE TABLE TMDB_AlternateOrdering_Episode ( TMDB_AlternateOrdering_EpisodeID INT IDENTITY(1,1) NOT NULL, TmdbShowID INT NOT NULL, TmdbEpisodeGroupCollectionID NVARCHAR(64) NOT NULL, TmdbEpisodeGroupID NVARCHAR(64) NOT NULL, TmdbEpisodeID INT NOT NULL, SeasonNumber INT NOT NULL, EpisodeNumber INT NOT NULL, CreatedAt DATETIME NOT NULL, LastUpdatedAt DATETIME NOT NULL );"),
