...
public static class RepositoryStartup
{
    public static IServiceCollection AddRepositories(this IServiceCollection services)
    {
        ...
        services.AddCachedRepository<CrossRef_AniDB_Anilist_AnimeRepository>();
        services.AddCachedRepository<CrossRef_AniDB_Anilist_EpisodeRepository>();
        services.AddCachedRepository<Anilist_AnimeRepository>();
        services.AddCachedRepository<Anilist_EpisodeRepository>();
        services.AddCachedRepository<Anilist_CharacterRepository>();
        services.AddCachedRepository<Anilist_CreatorRepository>();
        services.AddCachedRepository<Anilist_Anime_CharacterRepository>();
        ...
        services.AddCachedRepository<Anilist_Anime_StudioRepository>();
        services.AddCachedRepository<Anilist_Anime_ExternalLinkRepository>();
