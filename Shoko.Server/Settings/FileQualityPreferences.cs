...
public class FileQualityPreferences
{
    ...
    public List<FileQualityFilter.FileQualityFilterType> PreferredTypes { get; set; } =
    [
        FileQualityFilter.FileQualityFilterType.SOURCE,
        FileQualityFilter.FileQualityFilterType.RESOLUTION,
        FileQualityFilter.FileQualityFilterType.AUDIOSTREAMCOUNT,
        FileQualityFilter.FileQualityFilterType.SUBSTREAMCOUNT,
        FileQualityFilter.FileQualityFilterType.SUBGROUP,
        FileQualityFilter.FileQualityFilterType.CHAPTER,
        FileQualityFilter.FileQualityFilterType.VIDEOCODEC,
        FileQualityFilter.FileQualityFilterType.AUDIOCODEC,
        FileQualityFilter.FileQualityFilterType.VERSION,
    ];
    ...
    public List<string> PreferredResolutions { get; set; } = ["2160p", "1440p", "1080p", "720p", "480p"];
    ...
    public List<string> PreferredSubGroups { get; set; } = ["fffpeeps", "doki", "commie", "horriblesubs"];
    ...
    public List<FileQualityFilter.FileQualityFilterType> RequiredTypes { get; set; } =
    [
    ...
    public FileQualityTypeListPair<int> RequiredAudioStreamCount { get; set; } =
        new FileQualityTypeListPair<int>(1, FileQualityFilter.FileQualityFilterOperationType.GREATER_EQ);
    ...
    public FileQualityTypeListPair<List<string>> RequiredResolutions { get; set; } =
        new FileQualityTypeListPair<List<string>>(["1080p"],
    ...
    public FileQualityTypeListPair<List<string>> RequiredSources { get; set; } =
        new FileQualityTypeListPair<List<string>>(["bd", "dvd"],
            FileQualityFilter.FileQualityFilterOperationType.IN);
    ...
    public FileQualityTypeListPair<List<string>> RequiredSubGroups { get; set; } =
        new FileQualityTypeListPair<List<string>>(["horriblesubs"], FileQualityFilter.FileQualityFilterOperationType.NOTIN);
    ...
    public FileQualityTypeListPair<List<string>> RequiredVideoCodecs { get; set; } =
        new FileQualityTypeListPair<List<string>>(["hevc", "h264"],
            FileQualityFilter.FileQualityFilterOperationType.IN);
    ...
    [JsonIgnore] public List<string> _sources = ["bd", "dvd", "tv", "www", "unknown"];
    ...
    {
        public FileQualityFilter.FileQualityFilterOperationType Operator { get; set; }
        public T Value { get; set; }

        public FileQualityTypeListPair() { }

        public FileQualityTypeListPair(T value, FileQualityFilter.FileQualityFilterOperationType type)
        {
            Value = value;
            Operator = type;
        }
