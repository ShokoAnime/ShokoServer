...
public class VideoFileHashedEventSignalRModel : VideoFileEventSignalRModel
{
    public VideoFileHashedEventSignalRModel(VideoFileHashedEventArgs eventArgs) : base(eventArgs)
    {
