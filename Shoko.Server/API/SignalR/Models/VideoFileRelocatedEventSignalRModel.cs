...
public class VideoFileRelocatedEventSignalRModel : VideoFileEventSignalRModel
{
    public VideoFileRelocatedEventSignalRModel(VideoFileRelocatedEventArgs eventArgs) : base(eventArgs)
    {
