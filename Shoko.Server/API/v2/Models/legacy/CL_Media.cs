...
#nullable disable
namespace Shoko.Server.API.v2.Models.legacy;

[XmlType("Media")]
[DataContract]
[Serializable]
public class CL_Media
{
    [DataMember(EmitDefaultValue = false, Order = 1)]
    [XmlElement("Part")]
    public List<CL_MediaPart> Parts { get; set; }
    ...
    /// <param name="id"></param>
    /// <param name="m"></param>
    public CL_Media(int id, IMediaInfo m)
    {
        Id = id;
    ...
    public static CL_MediaStream TranslateVideoStream(IMediaInfo mediaInfo)
    {
    ...
    public static IEnumerable<CL_MediaStream> TranslateAudioStreams(IMediaInfo mediaInfo)
    {
        if (mediaInfo is null)
            return new List<CL_MediaStream>();
    ...
    public static IEnumerable<CL_MediaStream> TranslateTextStreams(IMediaInfo mediaInfo)
    {
        if (mediaInfo is null)
            return new List<CL_MediaStream>();
