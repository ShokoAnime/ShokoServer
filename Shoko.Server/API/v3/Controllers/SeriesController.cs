...
public class SeriesController : BaseController
{
    ...
    )
    {
        ...
        if (body != null && body.ID > 0)
            ...
            await _tmdbMetadataService.RemoveAllMovieLinks(series.AniDB_ID, body?.Purge ?? true);
    ...
    )
    {
        ...
        if (body != null && body.ID > 0)
            ...
            await _tmdbMetadataService.RemoveAllShowLinks(series.AniDB_ID, body?.Purge ?? true);
