...
namespace Shoko.Server.API.v3.Models.Shoko
{
    ...
    public class WebUI
    {
        ...
        {
            public WebUIGroupExtra(HttpContext context, SVR_AnimeGroup group, SVR_AnimeSeries series, SVR_AniDB_Anime anime, TagFilter.Filter filter = TagFilter.Filter.None)
            {
