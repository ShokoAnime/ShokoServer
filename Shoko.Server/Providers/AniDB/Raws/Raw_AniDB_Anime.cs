...
namespace Shoko.Server.Providers.AniDB.Raws
{
    ...
    public class Raw_AniDB_Anime : XMLBase
    {
        ...
        {
            get { return Commons.Utils.AniDB.GetAniDBDateAsSeconds(AirDate); }
        }

        [XmlIgnore]
        public int EndDateAsSeconds
        {
            get { return Commons.Utils.AniDB.GetAniDBDateAsSeconds(EndDate); }
        }
        ...
        public Raw_AniDB_Anime(string sRecMessage)
        {
            ...
            AirDate = Commons.Utils.AniDB.GetAniDBDateAsDate(airDateSeconds);
            EndDate = Commons.Utils.AniDB.GetAniDBDateAsDate(endDateSeconds);
