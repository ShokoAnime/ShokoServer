...
public class AniDbRateLimiter
{
    ...
    public AniDbRateLimiter(ILogger logger, ConfigurationProvider<ServerSettings> settingsProvider, Func<IServerSettings, AnidbRateLimitSettings> settingsSelector)
    {
        _logger = logger;
        _requestWatch.Start();
