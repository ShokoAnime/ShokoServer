...
{
    [DataMember(Name = "shows")] public List<TraktV2ShowWatchedPostByNumber> shows { get; set; }
    ...
    public TraktV2SyncWatchedEpisodesByNumber(string slug, int season, int episodeNumber, DateTime watchedDate)
    {
        ...
        shows[0].ids = new TraktV2IdsWatchedByNumber { slug = slug };
    ...
    public void AddEpisode(string slug, int season, int episodeNumber, DateTime watchedDate)
    {
        ...
        if (thisShow == null)
        {
            ...
            {
                ids = new TraktV2IdsWatchedByNumber { slug = slug },
        ...
        if (thisSeason == null)
        {
            ...
            {
                number = season, episodes = new List<TraktV2EpisodeWatchedPostByNumber>()
            };
        ...
        if (thisEp == null)
        {
            ...
            {
                number = episodeNumber, watched_at = watchedDate.ToUniversalTime().ToString("s") + "Z"
            };
...
{
    [DataMember(Name = "ids")] public TraktV2IdsWatchedByNumber ids { get; set; }

    [DataMember(Name = "seasons")] public List<TaktV2SeasonWatchedPostByNumber> seasons { get; set; }
}
...
{
    [DataMember(Name = "watched_at")] public string watched_at { get; set; }
...
public class TaktV2SeasonWatchedPostByNumber
{
    ...
    [DataMember(Name = "episodes")] public List<TraktV2EpisodeWatchedPostByNumber> episodes { get; set; }
}
