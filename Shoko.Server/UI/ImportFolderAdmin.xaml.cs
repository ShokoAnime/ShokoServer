            ...
            try
            {
                if (obj.GetType() == typeof(SVR_ImportFolder))
                {
                    ...
                    MessageBoxResult res =
                        MessageBox.Show(
                            string.Format(Shoko.Server.Properties.Resources.ImportFolders_RemoveFolder,
                                ns.ImportFolderLocation),
                            Shoko.Server.Properties.Resources.Confirm, MessageBoxButton.YesNo, MessageBoxImage.Question);
