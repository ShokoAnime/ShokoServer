...
public static class ModelClients
{
    public static CL_ServerSettings ToClient(this IServerSettings settings)
        => new()
        {
            ...
            AniDB_MyList_AddFiles = settings.AniDb.MyList.AddFiles,
            AniDB_MyList_StorageState = (int)settings.AniDb.MyList.StorageState,
            AniDB_MyList_DeleteType = (int)settings.AniDb.MyList.DeleteType,
            AniDB_MyList_ReadWatched = settings.AniDb.MyList.ReadWatched,
            AniDB_MyList_ReadUnwatched = settings.AniDb.MyList.ReadUnwatched,
            AniDB_MyList_SetWatched = settings.AniDb.MyList.SetWatched,
            AniDB_MyList_SetUnwatched = settings.AniDb.MyList.SetUnwatched,
            AniDB_MyList_UpdateFrequency = (int)settings.AniDb.MyList.UpdateFrequency,
