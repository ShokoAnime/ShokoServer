...
public class AniDB_Episode_PreferredImage
{
    ...
    public IImageMetadata? GetImageMetadata()
    {
        ...
        {
            DataSourceType.AniDB when ImageType is ImageEntityType.Poster => RepoFactory.AniDB_Anime.GetByAnimeID(AnidbAnimeID) is var anime ? anime.GetImageMetadata(true) : null,
