...
public class PlexLibrary
{
    ...
    [DataMember(Name = "banner")] public string Banner { get; set; } = null!;
    ...
    [DataMember(Name = "Genre")] public TagHolder[] Genre { get; set; } = null!;
    [DataMember(Name = "Role")] public TagHolder[] Role { get; set; } = null!;
    [DataMember(Name = "skipChildren")] public bool? SkipChildren { get; set; }
    [DataMember(Name = "theme")] public string Theme { get; set; } = null!;
