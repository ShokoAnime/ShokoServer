...
public class AniDBUdpRateLimitedAcquisitionFilter : IAcquisitionFilter
{
    ...
    public IEnumerable<Type> GetTypesToExclude() => !_connectionHandler.IsAlive || _connectionHandler.IsBanned || _connectionHandler.IsInvalidSession ? _types : Array.Empty<Type>();
