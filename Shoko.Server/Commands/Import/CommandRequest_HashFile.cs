...
public class CommandRequest_HashFile : CommandRequestImplementation
{
    ...
    protected override void Process()
    {
        ...
        shouldSave |= changed;
        var shouldHash = needEd2k || needCRC32 || needMD5 || needSHA1 || ForceHash;
    ...
    private (bool shouldSave, SVR_VideoLocal, SVR_VideoLocal_Place, SVR_ImportFolder) GetVideoLocal()
    {
