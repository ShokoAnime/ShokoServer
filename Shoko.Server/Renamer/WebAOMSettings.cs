...
public class WebAOMSettings : IRelocationProviderConfiguration, IConfigurationWithNewFactory<WebAOMSettings>
{
    [Display(
    ...
    [CodeEditor(CodeEditorLanguage.PlainText)]
    public string Script { get; set; } = string.Empty;

    public static WebAOMSettings New(IConfigurationService service, IPluginManager pluginManager) => new()
    {
        Script = """
