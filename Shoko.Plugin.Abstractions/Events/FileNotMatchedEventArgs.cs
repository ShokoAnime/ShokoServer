...
public class FileNotMatchedEventArgs : FileEventArgs
{
    ...
    public FileNotMatchedEventArgs(string relativePath, IImportFolder importFolder, IVideoFile fileInfo, IVideo videoInfo, IEnumerable<IEpisode> episodeInfo, IEnumerable<ISeries> animeInfo, IEnumerable<IGroup> groupInfo, int autoMatchAttempts, bool hasCrossReferences, bool isUdpBanned)
