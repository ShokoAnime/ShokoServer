...
public class SeriesVotedEventArgs : EventArgs
{
    ...
    /// <summary>
    /// The type of vote ("Permanent" or "Temporary").
    /// </summary>
    ...
    /// </summary>
    public SeriesVotedEventArgs(IShokoSeries series, ISeries anidbAnime, decimal voteValue, string voteType, IShokoUser user)
    {
        Series = series;
