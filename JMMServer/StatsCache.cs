...
namespace JMMServer
{
    public class StatsCache
    {
        ...
        public Dictionary<int, Contract_AniDB_AnimeDetailed> StatAnimeContracts = null;
        ...
        */
        ...
        public void InitStats()
        {
            try
            {
                ...
                Dictionary<int, List<int>> allAnimeTagsDict = new Dictionary<int, List<int>>();
                    // animeid / list of tag id's
                ...
                switch (gfc.ConditionTypeEnum)
                {
                    ...
                    case GroupFilterConditionType.MissingEpisodes:
                        ...
                        if (gfc.ConditionOperatorEnum == GroupFilterOperator.Exclude &&
                            grp.HasMissingEpisodesAny == true) return false;
                        break;
                    ...
                    case GroupFilterConditionType.MissingEpisodesCollecting:
                        ...
                        if (gfc.ConditionOperatorEnum == GroupFilterOperator.Exclude &&
                            grp.HasMissingEpisodesGroups == true) return false;
                        break;
                    ...
                    case GroupFilterConditionType.HasWatchedEpisodes:
                        ...
                        if (gfc.ConditionOperatorEnum == GroupFilterOperator.Include && userRec.AnyFilesWatched == false)
                            return false;
                        if (gfc.ConditionOperatorEnum == GroupFilterOperator.Exclude && userRec.AnyFilesWatched == true)
                            return false;
                        break;
                    ...
                    case GroupFilterConditionType.HasUnwatchedEpisodes:
                        ...
                        if (gfc.ConditionOperatorEnum == GroupFilterOperator.Exclude &&
                            userRec.HasUnwatchedFiles == true) return false;
                        break;
                    ...
                    case GroupFilterConditionType.AssignedTvDBInfo:
                        ...
                        if (gfc.ConditionOperatorEnum == GroupFilterOperator.Exclude &&
                            contractGroup.Stat_HasTvDBLink == true) return false;
                        break;
                    ...
                    case GroupFilterConditionType.AssignedMALInfo:
                        ...
                        if (gfc.ConditionOperatorEnum == GroupFilterOperator.Exclude &&
                            contractGroup.Stat_HasMALLink == true) return false;
                        break;
                    ...
                    case GroupFilterConditionType.AssignedMovieDBInfo:
                        ...
                        if (gfc.ConditionOperatorEnum == GroupFilterOperator.Exclude &&
                            contractGroup.Stat_HasMovieDBLink == true) return false;
                        break;
                    ...
                    case GroupFilterConditionType.AssignedTvDBOrMovieDBInfo:
                        ...
                        if (gfc.ConditionOperatorEnum == GroupFilterOperator.Exclude &&
                            contractGroup.Stat_HasMovieDBOrTvDBLink == true) return false;
                        break;
                    ...
                    case GroupFilterConditionType.CompletedSeries:
                        ...
                        if (gfc.ConditionOperatorEnum == GroupFilterOperator.Exclude &&
                            contractGroup.Stat_IsComplete == true) return false;
                        break;
