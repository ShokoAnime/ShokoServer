    ...
    public class Raw_AniDB_Episode : XMLBase
    {
        ...
        */
        ...
        private void ProcessEpisodeSource(string sRecMessage)
        {
            ...
            var sDetails = sRecMessage.Substring(12).Split('|');
            ...
            var epno = GetValidatedEpisodeNumber(sDetails[5].Trim());
        ...
        public void ProcessEpisodeSource(XmlNode node, int anid)
        {
            ...
            var adate = AniDBHTTPHelper.TryGetProperty(node, "airdate");
        ...
        private void ProcessFileSource(string sRecMessage)
        {
            ...
            var epno = GetValidatedEpisodeNumber(sDetails[18].Trim());
