...
namespace AniDBAPI.Commands
{
    public class AniDBCommand_GetUpdated : AniDBUDPCommand, IAniDBUDPCommand
    {
                ...
                case "243":
                    {
                        ...
                        var sDetails = socketResponse.Substring(0).Split('\n');
        ...
        public void Init(string startTime)
        {
            ...
            commandText = string.Format("UPDATED entity=1&time={0}", StartTime);
