        ...
        */
            ...
            if (ServerSettings.AutoGroupSeries)
            {
                ...
                if (grps != null && grps.Count > 0)
                {
                    ...
                    foreach (AnimeGroup grp in grps)
                    {
                        ...
                        if (ser.AnimeGroupID == grp.AnimeGroupID) continue;
                        ...
                        if (hasCustomName && (!newGroup.DefaultAnimeSeriesID.HasValue || name.AnimeSeriesID != newGroup.DefaultAnimeSeriesID.Value))
                            newTitle = newGroup.GroupName;
        ...
        public static void GetRelatedAnimeRecursive(ISession session, int animeID, ref List<AniDB_Anime> relList, ref List<int> relListIDs, ref List<int> searchedIDs)
        {
            ...
            foreach (AniDB_Anime_Relation rel in anime.GetRelatedAnime(session))
            {
                ...
                // this setting is for if you want those cases grouped. All gundam, macross, etc should be together
