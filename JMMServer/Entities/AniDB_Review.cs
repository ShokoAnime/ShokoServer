...
namespace JMMServer.Entities
{
    public class AniDB_Review
    {
        ...
        public void Populate(Raw_AniDB_Review rawReview)
        {
            ...
            AuthorID = rawReview.AuthorID;
            RatingAnimation = rawReview.RatingAnimation;
            RatingSound = rawReview.RatingSound;
            RatingStory = rawReview.RatingStory;
            RatingCharacter = rawReview.RatingCharacter;
            RatingValue = rawReview.RatingValue;
            RatingEnjoyment = rawReview.RatingEnjoyment;
