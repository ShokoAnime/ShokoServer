...
namespace JMMServer.Entities
{
    public class TvDB_ImagePoster
    {
        ...
        {
            var contract = new Contract_TvDB_ImagePoster();
            contract.TvDB_ImagePosterID = TvDB_ImagePosterID;
            contract.Id = Id;
        ...
        public bool Populate(int seriesID, XmlNode node, TvDBImageNodeType nodeType)
        {
            ...
            {
                logger.ErrorException("Error in TvDB_ImagePoster.Populate: " + ex, ex);
                return false;
            }
        }
    }
