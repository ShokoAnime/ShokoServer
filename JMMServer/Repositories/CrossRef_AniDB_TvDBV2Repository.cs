...
namespace JMMServer.Repositories
{
	public class CrossRef_AniDB_TvDBV2Repository
	{
		...
		public List<CrossRef_AniDB_TvDBV2> GetByAnimeIDEpTypeEpNumber(ISession session, int id, int aniEpType, int aniEpisodeNumber)
		{
			var xrefs = session
				.CreateCriteria(typeof(CrossRef_AniDB_TvDBV2))
				.Add(Restrictions.Eq("AnimeID", id))
		...
		public CrossRef_AniDB_TvDBV2 GetByTvDBID(ISession session, int id, int season, int episodeNumber, int animeID, int aniEpType, int aniEpisodeNumber)
		{
		...
		public CrossRef_AniDB_TvDBV2 GetByTvDBID(int id, int season, int episodeNumber, int animeID, int aniEpType, int aniEpisodeNumber)
		{
			using (var session = JMMService.SessionFactory.OpenSession())
			{
