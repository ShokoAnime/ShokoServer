...
{
    public class CrossRef_Subtitles_AniDB_FileRepository
    {
        ...
        public CrossRef_Subtitles_AniDB_File GetByID(int id)
        {
            using (var session = JMMService.SessionFactory.OpenSession())
            {
                return session.Get<CrossRef_Subtitles_AniDB_File>(id);
            }
        }
