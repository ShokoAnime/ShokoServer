...
namespace BinaryNorthwest
{
    ...
    public class CompareProperties<T> : IComparer<T> where T : class
    {
        ...
        public int StringCompare(T x, T y)
        {
            ...
            var nComp = string.Compare((string)property.GetValue(x), (string)property.GetValue(y),
        ...
        public int CompareIntDesc(T x, T y)
        {
            ...
            var oX = (int)property.GetValue(x);
            var oY = (int)property.GetValue(y);
        ...
        public int CompareUsingToString(T x, T y)
        {
            ...
            var oX = property.GetValue(x);
            var oY = property.GetValue(y);
            int nComp;
        ...
        public int CompareUsingToByte(T x, T y)
        {
            ...
            var oX = Convert.ToByte(property.GetValue(x));
            var oY = Convert.ToByte(property.GetValue(y));
            var nComp = oX > oY ? 1 : (oX < oY ? -1 : 0);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareUsingToInt(T x, T y)
        {
            ...
            var oX = Convert.ToInt32(property.GetValue(x));
            var oY = Convert.ToInt32(property.GetValue(y));
            var nComp = oX > oY ? 1 : (oX < oY ? -1 : 0);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareUsingToInt64(T x, T y)
        {
            ...
            var oX = Convert.ToInt64(property.GetValue(x));
            var oY = Convert.ToInt64(property.GetValue(y));
            var nComp = oX > oY ? 1 : (oX < oY ? -1 : 0);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareUsingToDouble(T x, T y)
        {
            ...
            var oX = Convert.ToDouble(property.GetValue(x));
            var oY = Convert.ToDouble(property.GetValue(y));
            var nComp = oX > oY ? 1 : (oX < oY ? -1 : 0);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareUsingToDate(T x, T y)
        {
            ...
            var oX = Convert.ToDateTime(property.GetValue(x));
            var oY = Convert.ToDateTime(property.GetValue(y));
            var nComp = oX.CompareTo(oY);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareDates(T x, T y)
        {
            ...
            var oX = (DateTime)property.GetValue(x);
            var oY = (DateTime)property.GetValue(y);
            var nComp = oX.CompareTo(oY);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareTypeSensitive<T2>(T x, T y) where T2 : IComparable<T2>
        {
            ...
            var oX = (T2)property.GetValue(x);
            var oY = (T2)property.GetValue(y);
            var nComp = oX.CompareTo(oY);
            return !fSortDescending ? nComp : -nComp;
        }
    ...
    public class CompareFields<T> : IComparer<T> where T : class
    {
        ...
        public int StringCompare(T x, T y)
        {
            var nComp = string.Compare((string)fi.GetValue(x), (string)fi.GetValue(y), stringComparisonToUse);
            return !fSortDescending ? nComp : -nComp;
        }

        public int StringCompareOrdinal(T x, T y)
        {
            var nComp = string.Compare((string)fi.GetValue(x), (string)fi.GetValue(y), StringComparison.Ordinal);
            return !fSortDescending ? nComp : -nComp;
        }

        public int CompareIntDesc(T x, T y)
        {
            var oX = (int)fi.GetValue(x);
            var oY = (int)fi.GetValue(y);
            return oX < oY ? 1 : (oX == oY ? 0 : -1);
        }
        ...
        public int CompareUsingToString(T x, T y)
        {
            var oX = fi.GetValue(x);
            var oY = fi.GetValue(y);
            int nComp;
            // handle null appropriately only for string sorting
            if (oX == null)
            {
        ...
        public int CompareUsingToByte(T x, T y)
        {
            var oX = Convert.ToByte(fi.GetValue(x));
            var oY = Convert.ToByte(fi.GetValue(y));
            var nComp = oX > oY ? 1 : (oX < oY ? -1 : 0);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareUsingToInt(T x, T y)
        {
            var oX = Convert.ToInt32(fi.GetValue(x));
            var oY = Convert.ToInt32(fi.GetValue(y));
            var nComp = oX > oY ? 1 : (oX < oY ? -1 : 0);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareUsingToInt64(T x, T y)
        {
            var oX = Convert.ToInt64(fi.GetValue(x));
            var oY = Convert.ToInt64(fi.GetValue(y));
            var nComp = oX > oY ? 1 : (oX < oY ? -1 : 0);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareUsingToDouble(T x, T y)
        {
            var oX = Convert.ToDouble(fi.GetValue(x));
            var oY = Convert.ToDouble(fi.GetValue(y));
            var nComp = oX > oY ? 1 : (oX < oY ? -1 : 0);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareUsingToDate(T x, T y)
        {
            var oX = Convert.ToDateTime(fi.GetValue(x));
            var oY = Convert.ToDateTime(fi.GetValue(y));
            var nComp = oX.CompareTo(oY);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareDates(T x, T y)
        {
            var oX = (DateTime)fi.GetValue(x);
            var oY = (DateTime)fi.GetValue(y);
            var nComp = oX.CompareTo(oY);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int CompareTypeSensitive<T2>(T x, T y) where T2 : IComparable<T2>
        {
            var oX = (T2)fi.GetValue(x);
            var oY = (T2)fi.GetValue(y);
            var nComp = oX.CompareTo(oY);
            return !fSortDescending ? nComp : -nComp;
        }
        ...
        public int FastCompareEnumsAsc(T x, T y)
        {
            ...
            if (!FastEnumLookup.TryGetValue(oX, out s1))
            {
                var eX = (Enum)fi.GetValue(x);
                s1 = eX.ToString();
                FastEnumLookup.Add(oX, s1);
            }
            if (!FastEnumLookup.TryGetValue(oY, out s2))
            {
                var eY = (Enum)fi.GetValue(y);
                s2 = eY.ToString();
                FastEnumLookup.Add(oY, s2);
            }
            return s1.CompareTo(s2);
