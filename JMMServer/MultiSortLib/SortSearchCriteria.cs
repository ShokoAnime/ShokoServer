...
namespace BinaryNorthwest
{
    ...
    public class SortPropOrFieldAndDirection
    {
        ...
        public IComparer<T> GetComparer<T>() where T : class
        {
            ...
            {
                var comp = new CompareProperties<T>(sPropertyOrFieldName, fSortDescending, sortType);
                comp.pi = pi;
                comp.Initialize();
            ...
            {
                var comp = new CompareFields<T>(sPropertyOrFieldName, fSortDescending, sortType);
                comp.fi = fi;
                comp.Initialize();
                comp.SetStringComparisonType(stringComparison);
                return comp;
    ...
    /// <summary>
    ///     A SortPropOrFieldAndDirection-derived class, SortPropertyAndDirection handles PropertyInfo caching and asc/desc
    ///     logic
    /// </summary>
    public class SortPropertyAndDirection : SortPropOrFieldAndDirection
    {
        public SortPropertyAndDirection()
        {
        }
