...
public class TmdbShowGenresSelector : FilterExpression<IReadOnlySet<string>>
{
    ...
    /// <inheritdoc/>
    public override string HelpDescription => "This returns a set of all the TMDB show genres in a filterable.";
    /// <inheritdoc/>
    ...
    protected bool Equals(TmdbShowGenresSelector other)
    {
    ...
    public override bool Equals(object? obj)
    {
        ...
        return Equals((TmdbShowGenresSelector)obj);
    }
