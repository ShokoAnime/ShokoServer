...
public class TmdbShowKeywordsSelector : FilterExpression<IReadOnlySet<string>>
{
    ...
    /// <inheritdoc/>
    public override string HelpDescription => "This returns a set of all the TMDB show keywords in a filterable.";
    /// <inheritdoc/>
    ...
    protected bool Equals(TmdbShowKeywordsSelector other)
    {
    ...
    public override bool Equals(object? obj)
    {
        ...
        return Equals((TmdbShowKeywordsSelector)obj);
    }
