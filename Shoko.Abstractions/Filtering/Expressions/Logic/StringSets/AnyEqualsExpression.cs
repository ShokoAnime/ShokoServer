...
/// <summary>
/// This condition passes if any of the values in the left selector equal either the right selector or the parameter
/// </summary>
public class AnyEqualsExpression : FilterExpression<bool>, IWithStringSetSelectorParameter, IWithSecondStringSelectorParameter, IWithStringParameter
{
    ...
    public override bool IsType(FilterExpression? expression)
        => expression is AnyEqualsExpression exp && (Left?.IsType(exp.Left) ?? true) && (Right?.IsType(exp.Right) ?? true);
}
