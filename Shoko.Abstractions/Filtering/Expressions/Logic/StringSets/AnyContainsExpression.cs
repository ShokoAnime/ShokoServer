...
/// <summary>
/// This condition passes if any of the values in the left selector contain either the right selector or the parameter
/// </summary>
public class AnyContainsExpression : FilterExpression<bool>, IWithStringSetSelectorParameter, IWithSecondStringSelectorParameter, IWithStringParameter
{
    ...
    public override bool IsType(FilterExpression? expression)
        => expression is AnyContainsExpression exp && (Left?.IsType(exp.Left) ?? true) && (Right?.IsType(exp.Right) ?? true);
}
