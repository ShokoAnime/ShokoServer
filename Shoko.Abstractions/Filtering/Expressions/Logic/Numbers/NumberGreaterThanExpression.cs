...
/// <summary>
/// This condition passes if the left selector is greater than either the right selector or the parameter
/// </summary>
public class NumberGreaterThanExpression : FilterExpression<bool>, IWithNumberSelectorParameter, IWithSecondNumberSelectorParameter, IWithNumberParameter
{
    ...
    public override bool IsType(FilterExpression? expression)
        => expression is NumberGreaterThanExpression exp && (Left?.IsType(exp.Left) ?? true) && (Right?.IsType(exp.Right) ?? true);
}
