...
/// <summary>
/// Dispatched when a video file is hashed and ready for use.
/// </summary>
...
public class VideoFileHashedEventArgs(string relativePath, IManagedFolder managedFolder, IVideoFile fileInfo, IVideo videoInfo) : VideoFileEventArgs(relativePath, managedFolder, fileInfo, videoInfo)
{
    /// <summary>
