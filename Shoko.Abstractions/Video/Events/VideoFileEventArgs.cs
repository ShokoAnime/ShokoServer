...
/// <summary>
///   Dispatched when a video file event is needed. This is shared across a few
///   events, and is also the base class for more specific events.
/// </summary>
public class VideoFileEventArgs : EventArgs
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VideoFileEventArgs"/> class.
    /// </summary>
    ...
    /// <remarks>
    /// This constructor is used to create an instance of <see cref="VideoFileEventArgs"/> when the relative path of the file is not known.
    /// </remarks>
    public VideoFileEventArgs(IManagedFolder managedFolder, IVideoFile fileInfo, IVideo videoInfo)
    ...
    /// </remarks>
    public VideoFileEventArgs(IManagedFolder managedFolder, IVideoFile fileInfo, IVideo videoInfo, IEnumerable<IShokoEpisode> episodeInfo, IEnumerable<IShokoSeries> animeInfo, IEnumerable<IShokoGroup> groupInfo)
