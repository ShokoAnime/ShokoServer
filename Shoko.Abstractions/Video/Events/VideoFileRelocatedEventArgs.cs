...
/// <summary>
/// Dispatched when a video file is moved or renamed.
/// </summary>
public class VideoFileRelocatedEventArgs : VideoFileEventArgs
{
    /// <summary>
    ...
    public VideoFileRelocatedEventArgs(string relativePath, IManagedFolder managedFolder, string previousRelativePath, IManagedFolder previousManagedFolder, IVideoFile fileInfo, IVideo videoInfo, IEnumerable<IShokoEpisode> episodeInfo, IEnumerable<IShokoSeries> animeInfo, IEnumerable<IShokoGroup> groupInfo)
