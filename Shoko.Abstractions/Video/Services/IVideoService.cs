...
public interface IVideoService
{
    ...
    /// </summary>
    event EventHandler<VideoFileDetectedEventArgs> VideoFileDetected;

    /// <summary>
    ///   Dispatched when a video file is deleted and removed from Shoko.
    /// </summary>
    event EventHandler<VideoFileEventArgs> VideoFileDeleted;
    ...
    /// </summary>
    event EventHandler<VideoFileRelocatedEventArgs> VideoFileRelocated;
    ...
    ///   Whether to skip the post-remove events for the removed files.
    /// </param>
    Task RemoveManagedFolder(IManagedFolder folder, bool keepRecords = false, bool skipEvents = false);
